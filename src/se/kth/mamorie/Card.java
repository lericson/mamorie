...
public class Card extends Component {
	 ...
	 * 
	 * @param id
	 *            Pair ID of the card, used for equality
	 * @param frontImageFile
	 *            Front image file
	 * @param backImageFile
	 *            Back image file
	 */
	...
	BufferedImage roundedImage(BufferedImage image) {
		...
		Shape shape = new RoundRectangle2D.Float(0, 0, w - 1, h - 1,
				CORNER_RADIUS, CORNER_RADIUS);
		Stroke stroke = new BasicStroke(STROKE_WIDTH, BasicStroke.CAP_ROUND,
